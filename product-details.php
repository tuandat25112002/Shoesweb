...
$nameproduct = filter_input(INPUT_GET,'nameproduct');
?>
<!doctype html>
...
<head>
    ...
    <title><?php echo $nameproduct;?></title>
                                ...
                                <div class="main_menu"> 
                                    <nav>  
                                        <ul>
                                            ...
                                            <li class="mega_items active"><a href="shop.html">shop</a>
    ...
    <div class="product_details">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5">
                   <div class="product-details-tab">
                        ...
                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#">
                                <img style="height: 500px;width: 100%;" id="zoom1" src="<?php echo $info['image'];?>" data-zoom-image="<?php echo $info['image'];?>" alt="big-1">
                            </a>
                        </div>
                        ...
                        <div class="single-zoom-thumb">
                            <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="<?php echo $info['image'];?>" data-zoom-image="<?php echo $info['image'];?>">
                                        <img src="<?php echo $info['image'];?>" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery " data-update="" data-image="<?php echo $info['image2'];?>" data-zoom-image="<?php echo $info['image2'];?>">
                                        <img src="<?php echo $info['image2'];?>" alt="zo-th-1"/>
                                    </a>
                ...
                <input type="hidden" value="<?php echo $info['IDproduct']?>" name="IDproduct">
    <input type="hidden" value="<?php echo $info['nameproduct']?>" name="nameproduct">
    <input type="hidden" value="<?php echo $info['gia']*((100-$info['sale'])/100)?>" name="gia">
    <input type="hidden" value="<?php echo $info['sale']?>" name="sale">  
    <input type="hidden" value="<?php echo $info['image']?>" name="image">   
                    <div class="product_d_right">
                            ...
                            <h1><?php echo $info['nameproduct'];?></h1>
                            ...
                            <?php 
                                               ...
                                               ?>                
                                                <span class="current_price" style="font-size: 20px;">$<?php echo $info['gia']*((100-$info['sale']))/100;?></span>
                                               <strike><span class="old_price">$<?php echo $info['gia'];?></span></strike> 
                                                <?php }
                                                else{
                                                    
                                                ?>
                                                <span class="current_price">$<?php echo $info['gia'];?></span>
                                                 <?php } ?> 
                            </div>
                            ...
                            <div class="product_variant size">
                                <h3>size</h3>
                                <select class="niceselect_option"  name="product_size">
                            ...
                            <button class="btn btn-danger" name="addcart" type="submit">Add to cart</button> 
                            <button class="btn btn-success" name="buyproduct" type="submit">Buy now</button>  
        ...
        <div class="container">
            ...
            <div class="product_area"> 
               ...
               // get all product of slected category
                   $sqlproduct = "SELECT * from products where categoryID='$categoryid' limit 8";
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single_product" >
                                            <div class="product_thumb">
                                                <a class="primary_img" href="product-details.php.?IDproduct=<?php echo $p['IDproduct']?>&nameproduct=<?php echo $p['nameproduct']?>"><img class="hinhdang" src="<?php echo $p['image']?>" alt=""></a>
                                                <a class="secondary_img"href="product-details.php.?IDproduct=<?php echo $p['IDproduct']?>&nameproduct=<?php echo $p['nameproduct']?>"><img  class="hinhdang" src="<?php echo $p['image2']?>" alt=""></a>

                                                <div class="quick_button">
                                                    <a href="product-details.php.?IDproduct=<?php echo $p['IDproduct']?>&nameproduct=<?php echo $p['nameproduct']?>" title="quick_view">Xem sản phẩm</a>
                                            ...
                                            <div class="product_content">
                                                <h3><a href="product-details.html"><?php echo $p['nameproduct'];?></a></h3>
                                                <?php 
                                                if($p['sale']!=0){
                                                        
                                               
                                               ?>                
                                                <span class="current_price">$<?php echo $p['gia']*((100-$p['sale']))/100;?></span>
                                                <span class="old_price">$<?php echo $p['gia'];?></span>
                                                <?php }
                                                else{
                                                    
                                                ?>
                                                <span class="current_price">$<?php echo $p['gia'];?></span>
                                                 <?php } ?>    
                                            </div>
                                        </div>
                                    </div>
    ...
    <section class="product_section upsell_product">
        <div class="container">
            ...
            <div class="product_area"> 
               ...
               // get all product of slected category
                   $sqlproduct = "SELECT * from products ORDER BY sale DESC limit 12";
                   $stm1 = $conn-> prepare($sqlproduct);
                   $stm1 -> execute();
                   $productinfo = $stm1->fetchAll();
                   $stm1->closeCursor();
                                ...
                                <div class="modal_tab">  
                                    <div class="tab-content product-details-large">
                                        ...
                                        <div class="tab-pane fade" id="tab2" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="<?php echo $info['image2'];?>" alt=""></a>    
                                            </div>
                                        </div>
