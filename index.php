...
<body>
    ...
    <div class="slider_area slider_style home_three_slider owl-carousel">
        <div class="single_slider" data-bgimg="assets/img/slider/slider8.jpg">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
        ...
        <div class="single_slider" data-bgimg="assets/img/slider/slide7.jpg">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
            ...
            <div class="row ">
               <div class="col-lg-4 col-md-6">
                    <div class="banner_area">
                        ...
                        <iframe width="100%" height="185px" src="https://www.youtube.com/embed/wmxpx11d09U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>   
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="banner_area">
                        <div class="banner_thumb">
                            <a href="shop.html"><img style="height:185px" src="assets/img/bg/banner9.jpg" alt="#"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="banner_area bottom">
                        <div class="banner_thumb">
                            <a href="shop.html"><img style="height:185px" src="assets/img/bg/banner2.jpg" alt="#"></a>
                        </div>
                    </div>
                </div>
            </div>
           ...
           <center><div style="height: 150;"> <h4 style="margin-bottom: 30px;padding: 0px;"> <img src="<?php echo $listcategories['logocategory']?>" style="width:150px" alt=""></h4>
            ...
            <div class="product_area"> 
                ...
                foreach($categories as $cname){
                    if($cname["categoryID"]==$category_id){
                            $active ="active";
                    }
                    else{
                        $active="";
                ...
                <li class="category"><a  class="<?php echo $active;?>"  href=".?category_id=<?php echo $cname["categoryID"]?>"><?php echo $cname['categoryName']; ?></a></li>
               <?php }?>
                            </ul>
                        </div>
                    </div>
                             ...
                             <div class="product_container">
                                ...
                                <?php
                                    ...
                                    // get all product of slected category
                                        $sqlproduct = "SELECT * from products where categoryID = $category_id LIMIT 10";
                                        ...
                                        <div class="single_product">
                                            <div class="product_thumb">
                                                ...
                                                <div class="quick_button">
                                                    <a href="product-details.php.?IDproduct=<?php echo $p['IDproduct']?>&nameproduct=<?php echo $p['nameproduct']?>" title="quick_view">View more</a>
        ...
        <div class="container">
            <div class="row">   
                <div class="col-12">
                   <div class="section_title">
                       <h2>HOT DALE</h2>
                       <p>Sale 50% for our Auth Product</p>
                   </div>
                </div> 
            </div>    
        ...
        <div class="container">
           <div class="row">
               <div class="col-12">
                   <div class="section_title">
                       <h2>News</h2>
                       <p>Update Shoes's news everyday</p>
                   </div>
               </div>
           </div>
            <div class="row">
